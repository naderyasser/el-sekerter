...
def instructions() -> str:
    ...
    lines.extend(
        [
            ...
            "```",
            "",
            "ومثال بأكثر من موعد في رسالة وحدة — «عندي اجتماع أبو سعد بكرة ١٠",
            "الصبح وتسليم الشحنة الخميس ١ الظهر» — **كل المواعيد في نفس",
            "المصفوفة، أمر لكل موعد، ولا تنسى ولا واحد**:",
            "",
            "أبشر، سجّلت الاثنين: اجتماع أبو سعد بكرة ١٠ الصبح، وتسليم "
            "الشحنة الخميس ١ الظهر.",
            "```" + FENCE,
            '[{"tool": "create_appointment", "input": {"title": "اجتماع أبو سعد",',
            ' "at": "2026-08-17T10:00:00+03:00", "remind_before_minutes": 60,',
            ' "repeat": "none", "notes": ""}},',
            ' {"tool": "create_appointment", "input": {"title": "تسليم الشحنة",',
            ' "at": "2026-08-20T13:00:00+03:00", "remind_before_minutes": 60,',
            ' "repeat": "none", "notes": ""}}]',
            "```",
        ]
    )
